        ...
        <Card className="mb-4">
          <CardContent className="p-4">
            ...
            <div className="space-y-3">
              <Button className="w-full bg-gray-200 dark:bg-gray-700 text-black dark:text-white font-bold hover:bg-gray-300 dark:hover:bg-gray-600 pulse-button" onClick={onAddToCart} data-testid="button-detail-add-cart">
                🛒 Adicionar
              </Button>
              <Button variant="outline" className="w-full font-bold pulse-button" onClick={onBuyNow} data-testid="button-buy-now">
                💳 Comprar (PIX)
              </Button>
            </div>
          </CardContent>
